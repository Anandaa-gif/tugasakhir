                ...
                <div class="col-md-8">
                    <form id="filterForm" action="{{ route('buku.tampil5') }}" method="GET"
                        ...
                        <div class="flex-grow-1">
                            <input type="text" name="search" class="form-control" placeholder="Cari judul / penulis / kode / ISBN"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('buku.detail', $item->id) }}" class="btn btn-sm btn-outline-warning" title="Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('buku.edit4', $item->id) }}" class="btn btn-sm btn-outline-success" title="Edit">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="file" name="file" class="form-control" id="excelFile" required accept=".xls,.xlsx">
