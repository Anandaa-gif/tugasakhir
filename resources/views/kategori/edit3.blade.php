            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0 rounded-3">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('kategori.update3', $kategori->id) }}" method="POST" class="needs-validation"
                            novalidate>
                            @csrf
                            @method('POST') {{-- Jika RESTful, ganti ke @method('PUT') sesuai kebutuhan --}}

                            {{-- Kode Kategori --}}
                            <div class="mb-3 row">
                                <label for="kode_kategori" class="col-md-4 col-form-label text-end fw-medium">Kode
                                    Kategori</label>
                                <div class="col-md-8">
                                    <input type="text"
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-8">
                                    <input type="text"
                                        ...
                                        name="name" id="name" value="{{ old('name', $kategori->name) }}" required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
